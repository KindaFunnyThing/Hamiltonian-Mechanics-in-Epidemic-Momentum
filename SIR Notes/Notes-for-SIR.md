...
Since the first infected person has the transmission rate and the population number, along with the infectious period's time chance to infect people around them, this means that the $basic reproduction rate$ of the disease would be $\mathbb{R}_0$