...
\begin{align}S^\ast=\frac{\left(\gamma+\mu\right)}{\beta}=\frac{1}{\operatorname{R}_0}\ #(2.9)\end{align}
\begin{align}I^\ast=\frac{\mu\left(R_0-1\right)}{\beta}#\left(2.10\right)\end{align}
\begin{align}R^\ast=N-S^\ast-I^\ast#\left(2.11\right)\end{align}
...
\begin{align}S\left(t+\Delta t\right)=S\left(t\right)+\ \nu N(t)\Delta t\ +\beta I\left(t\right)S\left(t\right)\Delta t\ -\ \mu S(t)\Delta t#\left(2.12\right)\end{align}
and
\begin{align}I\left(t+\Delta t\right)=I\left(t\right)+\beta S\left(t\right)I\left(t\right)\Delta t-\gamma I\left(t\right)\Delta t\ -\ \mu I(t)\Delta t#\left(2.13\right)\end{align}
